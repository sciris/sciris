...
def commaticks(ax=None, axis='y', precision=2, cursor_precision=0):
    ...
    **Example**::
    ...
    '''
    def commaformatter(x, pos=None): # pragma: nocover
...
def dateformatter(ax=None, style='sciris', dateformat=None, start=None, end=None,
    ...
    **Examples**::
    ...
    if dateformat is not None: # pragma: nocover
...
def loadmetadata(filename, load_all=False, die=True):
    ...
    **Example**::
    ...
    # Handle SVG
    elif lcfn.endswith('svg'): # pragma: nocover
...
def savefigs(figs=None, filetype=None, filename=None, folder=None, savefigargs=None, aslist=False, verbose=False, **kwargs):
    ...
    **Examples**::
    ...
    # Handle file types
    filenames = []
    if filetype=='singlepdf': # See http://matplotlib.org/examples/pylab_examples/multipage_pdf.html  # pragma: nocover
    ...
    for p,item in enumerate(figs.items()):
        ...
        else: # Any other case, generate a filename # pragma: nocover
...
class animation(scu.prettyobj):
    ...
    **Example**::
    ...
    def loadframes(self): # pragma: nocover
    ...
    def save(self, filename=None, fps=None, dpi=None, engine='ffmpeg', anim_args=None,
        ...
        if engine == 'ffmpeg': # pragma: nocover
        ...
        elif engine == 'matplotlib': # pragma: nocover
