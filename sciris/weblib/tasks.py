...
#    
#    def run(self):
#        return 'here be dummy result in tasks.py'
...
#
# Try moving stuff here for now.  If we get this to work, then we can possibly 
# get rid of make_celery() and thus the stuff nested in a function that might 
# be confusing the registration.
#
...
#
# This function works, so leave it alone for now.
#
