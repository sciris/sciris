...
ROOT_DIR = os.pardir + os.sep  # go up one directory from /bin

# Directory containing the client code.
#CLIENT_DIR = ROOT_DIR + 'vueinterface'
CLIENT_DIR = 'C:\\GitRepos\\OptimaRepos\\sciris\\examples\\scatterplotter\\vueinterface'
...
MODEL_DIR = 'C:\\GitRepos\\OptimaRepos\\sciris\\examples\\scatterplotter\\scirismodel'
...
WEBAPP_DIR = 'C:\\GitRepos\\OptimaRepos\\sciris\\examples\\scatterplotter\\webapp'

# Directory where uploaded files will be saved, as well as files saved to be 
# downloadable to user machines.
#UPLOADS_DIR = ROOT_DIR + 'uploads'
UPLOADS_DIR = 'C:\\GitRepos\\OptimaRepos\\sciris\\examples\\scatterplotter\\uploads'

# Directory where files may be saved that the web app should be able to 
# access.
#FILESAVEROOT_DIR = ROOT_DIR + 'savedfiles'
FILESAVEROOT_DIR = 'C:\\GitRepos\\OptimaRepos\\sciris\\examples\\scatterplotter\\savedfiles'
