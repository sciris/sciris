...
Sciris has MCP servers on [Context 7](https://context7.com/sciris/sciris) and [GitMCP](https://gitmcp.io/sciris/sciris). It also has a Claude Code plugin: to install, add this repository (<https://github.com/sciris/sciris>) to the Claude Code marketplace and from there install the plugin.
